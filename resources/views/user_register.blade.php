          ...
          <div class="col-12 col-md-8 col-lg-6 col-xl-5">
           <div class="card shadow-2-strong" style="border-radius: 1rem;">
            ...
            <div class="brand-logo">                  
                ...
                <div class="form-group"> 
                  <input type="number" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Contct No" name="user_moblie">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" id="myinputt" placeholder="Password" name="user_pass">
                  <input type="checkbox" class="form-check-input my-2 " onclick="myFunction()">Show Password
                </div>
                <div class="mt-3">
                <button type="Submit" class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn" name="AddUser
                ">Sign In</button>
                </div>
