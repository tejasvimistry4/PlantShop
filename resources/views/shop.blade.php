...
<body>
    ...
    <div class="breadcrumb-area">
        <!-- Top Breadcrumb Area -->
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(img/bg-img/50.jpg);">
            <h2>Shop</h2>
        </div>
                        ...
                        <div class="shop-widget price mb-50">
                            ...
                            <div class="widget-desc">
                                <div class="slider-range">
                                    <div data-min="100" data-max="600" data-unit="$" class="slider-range-price ui-slider ui-slider-horizontal ui-widget ui-widget-content ui-corner-all" data-value-min="100" data-value-max="600" data-label-result="Price:">                                      
                                        <div class="ui-slider-range ui-widget-header ui-corner-all"></div>
                                        <span class="ui-slider-handle ui-state-default ui-corner-all first-handle" tabindex="0"></span>
                                        <span class="ui-slider-handle ui-state-default ui-corner-all" tabindex="0"></span>
                                    </div>
                                    <div class="range-price">Price: $100 - $600</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="shop-widget catagory mb-50">
                            ...
                            <div class="widget-desc">
                             ...
                             <!--   <div class="custom-control custom-checkbox d-flex align-items-center mb-2">
                                    ...
                                    <label class="custom-control-label" for="customCheck1">{{$cat->category_name}}<span class="text-muted">(20)</span></label>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4 ">
                                <div class="single-product-area mb-50">
                                    ...
                                    <div class="product-img">
                                        <a href="/shop-details"><img src="{{asset('img/plantimg/'.$plt->product_tumb_img)}}" alt=""></a>
                                        <!-- Product Tag -->
                                    ...
                                    <div class="product-info mt-15 text-center">
                                        <a href="{{url('single_product', $plt->product_id)}}">
                                            <p>{{$plt->product_name}}</p>
                                        </a>
                                        <h6>&#8377;{{$plt->product_price}}</h6>
    ...
    <!-- ##### Footer Area Start ##### -->
    <footer class="footer-area bg-img" style="background-image: url(img/bg-img/24.jpg);">
        <!-- Main Footer Area -->
