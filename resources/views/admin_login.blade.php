          ...
          <div class="card shadow-2-strong" style="border-radius: 1rem;">
            <div class="card-body p-5 text-center">
              <div class="brand-logo">
                <img src="img/core-img/adlogo.png" alt="logo">
              </div>
              <h5 class="centered-text">Admin Login</h5>
              ...
              <form class="pt-2">
                <div class="form-group">
                  <input type="email" class="form-control form-control-lg" id="exampleInputEmail1" placeholder="Username" name="admin_email">
                </div>
                <div class="form-group">
                  <input type="password" class="form-control form-control-lg" placeholder="Password" name="admin_pass" id="myInput">
