                ...
                <div class="row justify-content-between">               
                                ...
                                <div class="carousel-inner">  
                                    ...
                                    <div class="carousel-item active">                                    
                                       <a class="product-img" href="" title="Product Image">
                                        <img class="d-block w-100" src="{{asset('img/prodimg/'.$plt->product_image)}}" alt="1">
                                    </a>                        
                                    </div>
                    ...
                    <div class="col-12 col-md-6">
                        <div class="single_product_desc">
                            <h4 class="title">{{$plt->product_name}}</h6>
                            <h6 ><del>{{$plt->product_sale_price}}</del></h6>
                            <h4 class="price">{{$plt->product_price}}</h4>
                            <h5 class="prodsize ">Select Product Size</h5>
                           
                            <div class="btn-outline-{color}">                           
                            <button type="button" class="btn btn-outline-primary">{{$plt->product_size}}</button>

                            </div>
                            <div class="short_overview pt-3">
                                <h5 class="">About the Product</h5>
                                <p>{{$plt->product_description}}</p>
                            </div>
                            ...
                            <div class="products--meta">
                                ...
                                <div class="card-header">
                                    ...
                                    <a class=" collapsed card-link" style="color: #000000" data-toggle="collapse" href="#collapseOne">
                                    {{$feat->prod_feature_title}}
                                    </a>
                                </div>
                                <div id="collapseOne" class="collapse show" style="color: #616161" data-parent="#accordion">
                                    <div class="card-body" >
                                    {{$feat->prod_feature_description}}
                                    </div>
                                </div>
                                </div>
                                @endforeach
                          ...
                          <!-- <div class="products--meta">
                                <div id="show">Water Twice A Week</div>
                                <div id="panl">Always check your plants before watering, the topsoil should be dry to touch. For succulents allow the potting mix to dry completely before watering again.
                                </div> -->
    ...
    <section class="testimonial-area section-padding-100">
        <div class="container">
            ...
            <div class="col-12  col-md-4">
                <div class="box-img">
                <img src="img/bg-img/49.jpg" alt="image">
                </div>
